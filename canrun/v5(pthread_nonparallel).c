...
//    }
    ...
    while (current != NULL) {
        ...
        if ((current->data =='+') || (current->data =='-')){
            ...
            args[threadcount].matrix2 = &matrices[next->data -'A'];
            args[threadcount].result = &matrices[temparr[tempcount]-'A'];
            pthread_create(&threads[threadcount], NULL, matrixAddition, (void*)&args[threadcount]);
            pthread_join(threads[threadcount], NULL);
            threadcount++;
//            matrixAddition(&matrices[previous->data -'A'],&matrices[next->data -'A'],&matrices[temparr[tempcount]-'A']);
            ...
            args[threadcount].matrix2 = &matrices[next->data -'A'];
            args[threadcount].result = &matrices[temparr[tempcount]-'A'];
            pthread_create(&threads[threadcount], NULL, matrixSubtraction, (void*)&args[threadcount]);
            pthread_join(threads[threadcount], NULL);
            threadcount++;
//            matrixSubtraction(&matrices[previous->data -'A'],&matrices[next->data -'A'],&matrices[temparr[tempcount]-'A']);
